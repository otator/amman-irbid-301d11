...
function displayPics(){
  ...
  // beacuse that const declares the variable within scope only which is the first while loop block {} and it is no longer declared if you tried to access it from outside that block which caused the error.
